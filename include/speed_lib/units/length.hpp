...
namespace speed_lib
{
    ...
    // base unit is m
    SPEED_LIB_DEFINE_UNIT_TRAITS(LengthTag, LENGTH_UNIT::M, 1.0L, 0.0L, "m", "m", "Length")
    SPEED_LIB_DEFINE_UNIT_TRAITS(LengthTag, LENGTH_UNIT::KM, 1000.0L, 0.0L, "km", "km", "Length")
    SPEED_LIB_DEFINE_UNIT_TRAITS(LengthTag, LENGTH_UNIT::MI, 1609.344L, 0.0L, "mi", "mi", "Length")
    SPEED_LIB_DEFINE_UNIT_TRAITS(LengthTag, LENGTH_UNIT::FT, 0.3048L, 0.0L, "ft", "ft", "Length")
