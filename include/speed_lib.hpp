...
///@brief we have no way atm to handle powers of units
...
/// @brief Formater specialization for Speed
...
/// @brief Formater specialization for Time
...
/// @brief Formater specialization for Length
